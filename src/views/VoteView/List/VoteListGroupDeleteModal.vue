<script setup>
  ...
  import useDeleteVoteGroup from '@/lib/queries/vote/useDeleteVoteGroup.js';
  ...
  const { deleteVoteGroupMutationAsync, isDeleteVoteGroupPending } =
    useDeleteVoteGroup();
  ...
  const deleteGroup = async () => {
    await deleteVoteGroupMutationAsync({ groupUuid: props.groupInfo.uuid });
    closeGroupModal();
  };
</script>
    ...
    <div class="min-w-[512px] max-w-[512px] p-6">
      ...
      <div class="flex justify-end gap-2">
        <ButtonBase
          ...
          color="secondary"
          size="md"
          :disabled="isDeleteVoteGroupPending"
        ...
        <ButtonBase
          ...
          @click="deleteGroup"
        >
          <SpinnerCircle v-if="isDeleteVoteGroupPending" />
