<script setup>
  ...
  import VoteListVoteCreationModal from '@views/VoteView/List/VoteListVoteCreationModal.vue';
  import { ref } from 'vue';
  ...
  >
    ...
    <div class="flex items-center gap-4">
      ...
      <ButtonBase
        ...
        @click.stop="createVote"
      >
        <PlusIcon class="h-4 w-4" /> 투표 추가
      </ButtonBase>
      <div>
        <ChevronDownIcon
          v-if="isOpen"
