<script setup>
  ...
  const isProgressState = computed(() => props.state === SURVEY_STATE.PROGRESS);
  const isPendingState = computed(() => props.state === SURVEY_STATE.PENDING);
