<script setup>
  ...
  import usePostSurvey from '@/lib/queries/survey/usePostSurvey.js';
  ...
  const { createSurveyMutationAsync, isCreateSurveyPending } = usePostSurvey();
  ...
  const onSubmit = handleSubmit(async (values) => {
    await createSurveyMutationAsync({
...
<template>
  <ModalBaseNew>
    <div class="min-w-[672px]">
      ...
      >
        <h1 class="pretendard-20Bold">설문 생성하기</h1>
        <button
          type="button"
          :disabled="isCreateSurveyPending"
      ...
      >
        <div class="flex gap-2">
          ...
          <ButtonBase
            ...
            :disabled="isCreateSurveyPending"
          >
            <SpinnerCircle v-if="isCreateSurveyPending" class="mx-auto" />
